<x-app-layout>
    <x-slot name="header">
        <div>
            <h2 class="ea-section-title">Создание объекта</h2>
            <p class="mt-1 text-sm text-slate-500">
                Добавление нового объекта в реестр недвижимости.
            </p>
        </div>
    </x-slot>
                ...
                <div class="grid gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
                    <div>
                        ...
                        <p class="mt-4 max-w-2xl text-sm leading-7 text-white/80">
                            Заполните основные характеристики объекта, статус и ответственного сотрудника.
                        </p>
                    </div>
                    ...
                    <div class="grid gap-3 sm:grid-cols-2">
                        <div class="rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur-sm">
                            ...
                            <div class="mt-2 text-lg font-semibold">Параметры объекта</div>
                        </div>

                        <div class="rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur-sm">
                            <div class="text-xs uppercase tracking-[0.2em] text-white/60">Результат</div>
                            <div class="mt-2 text-lg font-semibold">Новая запись в реестре</div>
                        </div>
                    </div>
                </div>
            </div>
