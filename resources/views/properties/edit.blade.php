<x-app-layout>
    <x-slot name="header">
        <div>
            <h2 class="ea-section-title">Редактирование объекта</h2>
            <p class="mt-1 text-sm text-slate-500">
                Изменение информации и параметров объекта недвижимости.
            </p>
        </div>
    </x-slot>
                ...
                <div class="grid gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
                    <div>
                        ...
                        <p class="mt-4 max-w-2xl text-sm leading-7 text-white/80">
                            Скорректируйте характеристики объекта, статус или ответственного сотрудника.
                        </p>
                    </div>
                    ...
                    <div class="grid gap-3 sm:grid-cols-2">
                        <div class="rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur-sm">
                            ...
                            <div class="mt-2 text-lg font-semibold">Изменение параметров</div>
                        </div>

                        <div class="rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur-sm">
                            <div class="text-xs uppercase tracking-[0.2em] text-white/60">Результат</div>
                            <div class="mt-2 text-lg font-semibold">Обновлённая карточка</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="ea-card-body">
                    ...
                    <form action="{{ route('properties.update', $property) }}" method="POST" class="space-y-6">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <a href="{{ route('properties.show', $property) }}" class="ea-btn-secondary">
                                Назад
                            </a>
                        </div>
                    </form>
